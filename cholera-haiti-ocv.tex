...
\fullcite{Lee:AchievingCoordinatedNational:2020}. 
...
The calibrated parameters are shown in table \ref{calibrationEPFL}. The model fit is shown in Figure \ref{fitEPFL}. An example of the number of individuals in the different compartments over time is shown in Figure \ref{figCompartiment}.

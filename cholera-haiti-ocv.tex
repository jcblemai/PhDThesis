\begin{fullwidth}
\chapter[Spatial stochastic model for modeling cholera elimination]{Estimating the probability of eliminating cholera from Haiti with a mass vaccination campaign}%Spatial stochatic model for modeling\\cholera elimination through mass vaccination campaigns}

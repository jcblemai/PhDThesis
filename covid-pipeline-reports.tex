...
\marginnote{\textsc{Initial parameters} Typically sigma and gamma are parameterized with estimates of the range of the serial interval (SI) or generation time, such that
\begin{equation}

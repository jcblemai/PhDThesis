...
\label{sec:covid-pipeline-reports}
  \end{fullwidth}
The ongoing Coronavirus disease 2019 (COVID-19, previously nCov) pandemic originated in Wuhan, China end of 2019. The pathogen is the severe acute respiratory syndrome coronavirus SARS-CoV-2. It is one of the deadliest pandemic in history, and the response has mobilized scientist, public-health and medical professionals and politics around the globe. This chapter presents some modeling works for the response to COVID-19. As state of knowledge on the SARS-CoV-2 and COVID-19 was and still is quickly expanding, the present chapter and the next highlight the challenges of dealing with such uncertainties. For the same reason, we do not endeavour a literature review\sidenote[][5\baselineskip]{That would be ambitious, with a bit less than 190'000 peer-reviewed papers and many more preprints, website and reports. Estimation from: \fullcite{COVID-19OpenAccessProject:LivingEvidenceCOVID19:2020}} of the current understanding of COVID-19 and modeling studies. 

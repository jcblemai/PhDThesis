...
%%%%%%%%%%%%%% BOOK DATA %%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title[PhD Thesis: infectious disease dynamics modeling towards informed control decisions]{Computational infectious disease dynamics modeling towards informed control decisions}
\date{\today}
...
%\usepackage{emoji} % we need emojis 
...
% we want margin figure caption header to be smaller to remove this weird size diperempty:
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage[backend=biber,doi=false,isbn=false,url=false,eprint=false,style=verbose,citestyle=authoryear,maxbibnames=999,maxcitenames=1,citetracker=true,pagetracker=true,uniquename=false]{biblatex}%,firstinits=true, before: authoryear-comp; unique name is false so we can de
...
\begin{document}
%
% r.3 full title page. % éà <- to make the document utf-8
%\maketitle

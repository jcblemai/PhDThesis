...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\usepackage[backend=biber,doi=false,isbn=false,url=false,eprint=false,style=verbose,citestyle=authoryear,maxbibnames=999,maxcitenames=1]{biblatex}%,firstinits=true, before: authoryear-comp
...
\DeclareCiteCommand{\fullcite}
  ...
  \DeclareCiteCommand{\fullciteshort}
  {\usebibmacro{prenote}}
  {%
...
\DeclareCiteCommand{\fullcite_short}
  {\usebibmacro{prenote}}%
...
\renewcommandx{\citecompact}[3][1={0pt},2={}]{\sidenote[][#1]{\fullciteshort[#2]{#3}.}}

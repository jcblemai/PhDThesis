...
% \usepackage{hyphenat}
\usepackage{url}
\usepackage[backend=biber,doi=false,isbn=false,url=false,eprint=false,style=verbose,citestyle=authoryear-comp]{biblatex}
...
%\AtEveryBibitem{}
\AtEveryCitekey{\clearfield{day}} % Remove day only in fullcite

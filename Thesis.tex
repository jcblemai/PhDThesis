...
% \usepackage{hyphenat}
\usepackage{url}
\usepackage[backend=biber,doi=false,isbn=false,url=false,eprint=false,style=authoryear,citestyle=authoryear-comp]{biblatex}
...
Testing different citation style, \texttt{fullcite}gives\fullcite{Lemaitre:AssessingImpactNonpharmaceutical:2020}.
While \texttt{cite} is
\cite{Lemaitre:AssessingImpactNonpharmaceutical:2020}... 

\texttt{parencite} would yield\parencite{Lemaitre:AssessingImpactNonpharmaceutical:2020}.

\texttt{footcite}yields\footcite{Lemaitre:AssessingImpactNonpharmaceutical:2020}.

However I can also use \texttt{textcite} which is nice: \textcite{Lemaitre:AssessingImpactNonpharmaceutical:2020}.

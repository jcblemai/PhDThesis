...
%%%%%%%%%%%%%% BOOK DATA %%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title[PhD Thesis: infectious disease dynamics modeling towards informed control decisions]{Modelling infectious disease \\ dynamics towards informed \\ public health interventions: \\ applications on \textsc{covid}-19 and cholera}
...
\backmatter
%\begin{appendices}\input{appendices}\input{matmet}\end{appendices}
